        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PublishedOnDate = table.Column<DateTime>(nullable: false),
                    PageCount = table.Column<int>(nullable: false),
                    IssueFolderPath = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageFilePath = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Issues_MagazineId",
                table: "Issues",
                column: "MagazineId");

            migrationBuilder.CreateIndex(
                name: "IX_Pages_IssueId",
                table: "Pages",
                column: "IssueId");
        }
